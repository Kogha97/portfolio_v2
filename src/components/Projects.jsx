...
export default function Projects() {
  ...
  const projects = [
    {
      name:'Budgeting app',
      imageUrl:'src/images/BudgetApp.JPG',
    ...
    {
      "name": "Portfolio v2",
      "imageUrl": "src/images/portfolioV1.JPG",
      ...
      {
        name:'Mini-Yelp',
        imageUrl:'src/images/mini-yelp.JPG',
      ...
      {
        name:'Cookbook v3',
        imageUrl:'src/images/cookbook3.JPG',
      ...
      {
        name: "Cookbook v2",
        imageUrl: "src/images/recipes.JPG",
      ...
      },    
      {
        ...
        imageUrl:'src/images/ipAdress.JPG',
      ...
      {
        name:'Calculator App',
        imageUrl:'src/images/calculator_app.JPG',
      ...
      {
        name:'Ordering App',
        imageUrl:'src/images/restaurant_app.JPG',
      ...
      {
        name:'To do List',
        imageUrl:'src/images/todolist.JPG',
      ...
      },
      {
        ...
        imageUrl:'src/images/cookbook.JPG',
      ...
      },
      {
        ...
        imageUrl:'src/images/lorem site.JPG',
